...
const careerCardController = { getProfile, putProfile, loginWithEmail, verifyEmail, retryVerify, signUpByEmail, socialLogin, logout, postPurchase, getPurchase, getLike, passwordMod };
